...
var receiveSearchGiphys = exports.receiveSearchGiphys = function receiveSearchGiphys(giphys) {
  return { type: RECEIVE_SEARCH_GIPHYS,
    giphys: giphys };
};
...
var giphyIndex = function giphyIndex(props) {
  console.log(props);
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(
      ...
      props.giphys.map(function (giphy) {
        return _react2.default.createElement(
          'li',
          { className: 'giphy-li' },
          _react2.default.createElement('img', { className: 'giphy', key: giphy.id, src: giphy.images.original.webp })
        );
      })
    )
  );
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          'Search:',
          _react2.default.createElement('input', { className: 'search-bar', type: 'text', value: this.state.search,
...
$(document).on("DOMContentLoaded", function () {
  ...
  window.store = store;
  _reactDom2.default.render(_react2.default.createElement(_root.Root, { store: store }), $("#root")[0]);
});
...
exports.default = (0, _redux.combineReducers)({ giphys: _giphys_reducer2.default });
